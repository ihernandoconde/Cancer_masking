...
# CNN model weights
model_path = r"F:\Leslie\uni\Y3\Programming\project\Repo\result\result_epoch{epoch + 1}.pth"
...
def predict_masks(image_path, model):
    ...
    if not isinstance(output, tuple):
        raise ValueError("Model output is not a tuple (breast, dense). Check your model definition.")
...
if __name__ == "__main__":
    # 1) segmenting and predicting
    print("\n=== Step1: Segmentation Inference ===")
    breast_pred, dense_pred = predict_masks(image_path, model)
